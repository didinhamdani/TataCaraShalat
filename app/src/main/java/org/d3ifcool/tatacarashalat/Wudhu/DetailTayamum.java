...
public class DetailTayamum extends AppCompatActivity {
    ...
    private class Adapter extends PagerAdapter {
        ...
        // list img
        int[] list_img = {
                R.drawable.tayamum_niat,
                R.drawable.tayamum_tepuk,
                R.drawable.tayamum_niup,
                R.drawable.tayamum_muka,
                R.drawable.tayamum_tangan,
                R.drawable.tayamum_doa_sesudah
        };

        // list judul
        int[] list_judul = {
                R.string.niat_tayamum,
                R.string.tayamum_tepuk,
                R.string.tayamum_niup,
                R.string.tayamum_muka,
                R.string.tayamum_tangan,
                R.string.doa_tayamum
        };

        // list deskripsi
        int[] list_desk = {
                R.string.arab_niat_tayamum,
                R.string.arab_tayamum_tepuk,
                R.string.arab_tayamum_tepuk,
                R.string.arab_tayamum_tepuk,
                R.string.arab_tayamum_tepuk,
        ...
        // list deskripsi
        int[] list_latin = {
                R.string.latin_niat_tayamum,
                R.string.arab_tayamum_tepuk,
                R.string.latin_tayamum_niup,
                R.string.arab_tayamum_tepuk,
                R.string.arab_tayamum_tepuk,

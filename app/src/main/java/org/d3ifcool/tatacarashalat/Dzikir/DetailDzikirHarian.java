...
public class DetailDzikirHarian extends AppCompatActivity {
    ...
    private class Adapter extends PagerAdapter {
        ...
        // list deskripsi
        int[] list_desk = {
                R.string.arab_dzikir1,
                R.string.arab_dzikir2,
                R.string.arab_dzikir3,
                R.string.arab_dzikir4,
                R.string.arab_dzikir5,
                R.string.arab_dzikir6,
                R.string.arab_dzikir7,
                R.string.arab_dzikir8,
                R.string.arab_dzikir9,
                R.string.arab_dzikir10
        };

        // list deskripsi
        int[] list_latin = {
                R.string.latin_dzikir1,
                R.string.latin_dzikir2,
                R.string.latin_dzikir3,
                R.string.latin_dzikir4,
                R.string.latin_dzikir5,
                R.string.latin_dzikir6,
                R.string.latin_dzikir7,
                R.string.latin_dzikir8,
                R.string.latin_dzikir9,
                R.string.latin_dzikir10
        };

        int[] list_arti = {
                R.string.arti_dzikir1,
                R.string.arti_dzikir2,
                R.string.arti_dzikir3,
                R.string.arti_dzikir4,
                R.string.arti_dzikir5,
                R.string.arti_dzikir6,
                R.string.arti_dzikir7,
                R.string.arti_dzikir8,
                R.string.arti_dzikir9,
                R.string.arti_dzikir10
        };
